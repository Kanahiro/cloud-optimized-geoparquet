...
for kind,(shape,depth,code) in shapes.items():
 ...
 geo={'version':'1.1.0','primary_column':'geometry','columns':{'geometry':{'encoding':'WKB','geometry_types':[kind],'covering':{'bbox':{k:['bounds',k] for k in ['xmin','ymin','xmax','ymax']}}}},'lod':{'levels':[{'row_group_end':0,'resolution':4},{'row_group_end':0,'resolution':2},{'row_group_end':2,'resolution':1}],'overviews':{'column':'render_geometry','encoding':'quantized_geoarrow','lods':{'coarse':{'level_indices':[0],'geometry_type':kind,'scale':[2,2],'offset':[10,20]},'fine':{'level_indices':[1,2],'geometry_type':kind,'scale':[1,1],'offset':[10,20]}}}}}
