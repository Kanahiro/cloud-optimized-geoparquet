...
LoD child's outermost list may be null. All nested lists, coordinate structs,
and coordinate values MUST be non-null. List element field names do not carry
...
or quantization. This encoding provides non-empty rendering geometries for
non-null, non-empty source geometries; files with null or empty source geometries
may omit overviews.
